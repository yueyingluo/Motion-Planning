...
if __name__ == '__main__':
    ...
    # planner = search_factory("informed_rrt", start=start, goal=goal, env=env, max_dist=0.5, r=12, sample_num=10000)
    ...
    # planner.plan()
    # end_time = time.time()
    # print(f"Planning time: {end_time - start_time:.10f} seconds")
